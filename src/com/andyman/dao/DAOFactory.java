...
public class DAOFactory {
	private static final String FICHIER_PROPERTIES ="com/andyman/dao/dao.properties";
	...
	public  Connection getConnection() throws SQLException {
		try {
			...
			throw new DAOException("Impossible de se connecter...",e);
		}
